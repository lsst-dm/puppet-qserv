...
2. [Setup - The basics of getting started with qserv](#setup)
    * [What qserv affects](#what-qserv-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with qserv](#beginning-with-qserv)
